...
class TreeAddForm(forms.Form):
    ...
    target = forms.ChoiceField(required=False, choices=[('edit', 'I\'m done!'),('addsame', 'I want to add another tree using the same tree details'), ('add', 'I want to add another tree with new details')], initial='add', widget=forms.RadioSelect)        
